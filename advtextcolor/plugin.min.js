var bool = false;
tinymce.PluginManager.add ("advtextcolor", function (editor)
{
	...
	$ (document).ready (function ()
	{
		...
		{
			bool = true;
			$ ('head').append ("<script src='/js/tiny_mce/plugins/advtextcolor/dependency/farbtastic.js'></script><link href='/js/tiny_mce/plugins/advtextcolor/dependency/farbtastic.css' rel='stylesheet' type='text/css'/>");
